...
class HateClassifier(pl.LightningModule):
    ...
    def __init__(self, args):
        ...
        if self.dataset == 'hmc':
            ...
            self.pretrained_weights_path = f'./resources/pretrained_weights/harmeme'
    ...
    def test_step(self, batch, batch_idx, dataloader_idx):
        ...
        if self.dataset == 'mcc_run' and prefix == 'test':
            for prob in output['values']:
